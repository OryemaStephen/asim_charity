...
const Service = () => {
  return (
    <div className='items-start justify-between w-full px-5 py-10 md:flex'>
        <div className='flex flex-col items-center justify-between gap-3'>
            <div className='text-[#F7CA44] text-6xl'><IoIosBulb /></div>
            <div>
        ...
        <div className='flex flex-col items-center justify-between gap-3'>
            <div className='text-[#F7CA44] text-6xl'><IoPeopleSharp /></div>
            <div>
        ...
        <div className='flex flex-col items-center justify-between gap-3'>
            <div className='text-[#F7CA44] text-6xl'><BiSolidDonateHeart /></div>
            <div >
